        ...
        <div class="row d-none d-lg-flex">
            <div class="col-lg-6 d-flex">
                ...
                <div class="input-group custom-search me-1">
                    ...
                    <input v-model="state.item.search" class="form-control custom search mimic" autocomplete="new-password" type="text" placeholder="备注">
                </div>
            ...
            <div class="col-12">
                <el-tabs v-model="state.item.tabs" v-on:tab-change="method.change" id="tabs-area" type="border-card">
                    ...
                    <el-tab-pane name="all">
                        ...
                        <table-api-keys :params="state.params.all" v-model:init="state.tabs.all" v-on:refresh="method.refresh" ref="all"></table-api-keys>
                    </el-tab-pane>
                    ...
                    <el-tab-pane name="remove">
                        ...
                        <table-api-keys :params="state.params.remove" v-model:init="state.tabs.remove" v-on:refresh="method.refresh" ref="remove" type="remove"></table-api-keys>
                    </el-tab-pane>
