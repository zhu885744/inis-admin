        ...
        <div class="row d-none d-lg-flex">
            <div class="col-lg-6 d-flex">
                ...
                <div class="input-group custom-search me-1">
                    ...
                    <input v-model="state.item.search" class="form-control custom search mimic" autocomplete="new-password" type="text" placeholder="名字 | 描述 | 备注">
                </div>
                <el-button v-on:click="method.refresh()" class="btn btn-auto mx-1 mimic">刷新</el-button>
                <el-button v-on:click="method.add()" v-if="state.item.tabs.includes('all')" class="btn btn-auto ms-1 mimic">添加</el-button>
            </div>
            <div class="col-lg-6 d-flex justify-content-end" style="z-index: -1">
                <el-button class="btn btn-auto mimic" disabled="false">
                    {{ state.item.title }}
                </el-button>
            </div>
        </div>
            ...
            <div class="col-12">
                <el-tabs v-model="state.item.tabs" v-on:tab-change="method.change" id="tabs-area" type="border-card">
                    ...
                    <el-tab-pane name="all">
                        ...
                        <table-badge :params="state.params.all" v-model:init="state.tabs.all" v-on:refresh="method.refresh" ref="all"></table-badge>
                    </el-tab-pane>
                    ...
                    <el-tab-pane name="remove">
                        ...
                        <table-badge :params="state.params.remove" v-model:init="state.tabs.remove" v-on:refresh="method.refresh" ref="remove" type="remove"></table-badge>
                    </el-tab-pane>
...
import TableBadge from '{src}/comps/admin/table/badge.vue'
