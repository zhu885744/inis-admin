            ...
            <div class="col-12">
                <el-tabs v-model="state.item.tabs" v-on:tab-change="method.change" id="tabs-area" type="border-card">
                    ...
                    <el-tab-pane name="all">
                        ...
                        <table-banner :params="state.params.all" v-model:init="state.tabs.all" v-on:refresh="method.refresh" ref="all"></table-banner>
                    </el-tab-pane>
                    ...
                    <el-tab-pane name="remove">
                        ...
                        <table-banner :params="state.params.remove" v-model:init="state.tabs.remove" v-on:refresh="method.refresh" ref="remove" type="remove"></table-banner>
                    </el-tab-pane>
