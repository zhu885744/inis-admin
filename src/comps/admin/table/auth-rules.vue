                ...
                <el-col :span="12">
                    <el-form-item label="费用">
                        <el-tooltip content="可用于接口计费模式" placement="top">
                            <span>
                                <i-svg color="rgb(var(--icon-color))" name="hint" size="14px"></i-svg>
                                <span style="margin-left: 4px">费用：</span>
                            </span>
                        </el-tooltip>
                ...
                <el-col :span="8">
                    <el-form-item label="请求类型">
                        <el-tooltip content="该接口的请求类型" placement="top">
                            <span>
                                <i-svg color="rgb(var(--icon-color))" name="hint" size="14px"></i-svg>
                                <span style="margin-left: 4px">请求类型：</span>
                            </span>
                        </el-tooltip>
                        <el-select v-model="state.struct.method" placeholder="请选择请求类型" style="display: block; font-size: 13px" class="custom">
                ...
                <el-col :span="8">
                    <el-form-item label="接口类型">
                        <el-tooltip placement="top">
                            ...
                            <span>
                                <i-svg color="rgb(var(--icon-color))" name="hint" size="14px"></i-svg>
                                <span style="margin-left: 4px">接口类型：</span>
                            </span>
                        </el-tooltip>
                        <el-select v-model="state.struct.type" placeholder="是否为公共接口" style="display: block; font-size: 13px" class="custom">
